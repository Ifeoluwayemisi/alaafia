            ...
            <div className="lg:col-span-6 p-8 sm:p-10 flex flex-col justify-between bg-white relative">
              ...
              {mode === "signin" && (
                <div className="space-y-6 animate-fadeIn">
                  ...
                  {/* Demo Login Button for Instant Testing */}
                  <button
                    type="button"
                    onClick={() => {
                      setIsLoading(true);
                      setSuccessMsg("Signing in with demo patient profile (Ruqayah Adebayo)...");
                    ...
                    className="w-full py-3 px-4 bg-teal-50 hover:bg-teal-100 border border-teal-200 text-[#005c6e] font-bold rounded-xl text-xs flex items-center justify-center gap-2 transition-all cursor-pointer shadow-2xs"
                  >
                    <Sparkles className="w-4 h-4 text-teal-600" />
                    <span>Instant Demo Access (Ruqayah Adebayo)</span>
                  </button>
              ...
              {/* FORM VIEW 3: VERIFY ACCOUNT PAGE (OTP Code Entry) */}
              {mode === "verify" && (
                <div className="space-y-6 animate-fadeIn">
                  {/* Top Back Link */}
                  <button
