      ...
      <div className="bg-white rounded-3xl p-6 sm:p-7 max-w-sm w-full border border-slate-200 shadow-2xl space-y-4 text-left">
        ...
        <div className="flex items-center justify-end gap-2.5 pt-3">
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-[#dc2626] hover:bg-[#b91c1c] text-white text-xs font-bold shadow-xs transition-all cursor-pointer"
          >
            Delete Account
          </button>
        </div>
